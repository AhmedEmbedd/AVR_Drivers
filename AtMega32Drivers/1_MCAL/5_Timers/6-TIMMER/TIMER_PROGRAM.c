...
static void (*Callback_Gpt_TIM0_OVF) (void) = NULL;
static void (*Callback_Gpt_TIM0_COMP) (void)= NULL;
static void (*Callback_Gpt_TIM1_OVF) (void) = NULL;
static void (*Callback_Gpt_TIM1_COMPA)(void) =NULL;
static void (*Callback_Gpt_TIM1_COMPB)(void) =NULL;
static void (*Callback_Gpt_TIM2_OVF) (void) = NULL;
static void (*Callback_Gpt_TIM2_COMP) (void) =NULL;

ISR(VECTOR_TIM0_OVF)
{
    if (NULL != Callback_Gpt_TIM0_OVF)
    {
...
{
    if (NULL != Callback_Gpt_TIM1_COMPA)
    {
...
{
    if (NULL != Callback_Gpt_TIM1_COMPB)
    {
...
{
    if (NULL != Callback_Gpt_TIM2_COMP)
    {
